...
20)^[Here, we will focus in data dependent acquisition (DDA), where
MS1 peaks a selected. In data independent acquisition (DIA), all peaks
...
is of high enough quality) of using a search engine such as, for
example Mascot, MSGF+, ..., that will match the observed, experimental
spectrum to theoratical spectra (see details below).
...
```{r prolocdata2, echo = FALSE, eval = FALSE}
